const CACHE='csm-wyvern-all-in-1-v2-offline-pdf';
const CORE=['./','./index.html','./manifest.webmanifest','./pdf-engine.js','./icons/icon-180.png','./icons/icon-512-v2.png','./icons/favicon-v2.png'];
